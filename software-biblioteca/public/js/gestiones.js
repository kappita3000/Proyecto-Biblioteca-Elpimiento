...
// Inicializar para cada pestaña
setupBulkDelete('selectAllAutores', 'select-item-autores', 'bulkDeleteAutoresForm');
setupBulkDelete('selectAllGeneros', 'select-item-generos', 'bulkDeleteGenerosForm');
setupBulkDelete('selectAllCategorias', 'select-item-categorias', 'bulkDeleteCategoriasForm');
setupBulkDelete('selectAllRepisas', 'select-item-repisas', 'bulkDeleteRepisasForm');
setupBulkDelete('selectAllEditoriales', 'select-item-editoriales', 'bulkDeleteEditorialesForm');
